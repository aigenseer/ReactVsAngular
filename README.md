...
This repository shows the different structure of a website with the different technologies of React and Angular. The project should offer a little help for the entry into the world of the single application.

For a brief overview of the technologies, you can simply take a look at the [demo](https://aigenseer.github.io/ReactVsAngular/) page. 
